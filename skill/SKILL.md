...
description: Write publication-ready HCI/Visualization papers for CHI, UIST, IEEE VIS, EuroVis, PacificVis, CSCW, DIS. Use when drafting papers from research repos, structuring arguments, verifying citations, or preparing camera-ready submissions. Includes LaTeX templates, reviewer guidelines, and citation verification workflows.
version: 1.0.0
author: Renzhong Li
license: MIT
tags: [Academic Writing, CHI, UIST, VIS, EuroVis, PacificVis, CSCW, DIS, LaTeX, Paper Writing, Citations, Research, HCI, Visualization]
dependencies: [semanticscholar, arxiv, habanero, requests]
---

# HCI/Visualization Paper Writing for Top Conferences

Expert-level guidance for writing publication-ready papers targeting **CHI, UIST, IEEE VIS, EuroVis, PacificVis, CSCW, and DIS**. This skill combines writing philosophy from top HCI/Vis researchers with practical tools: LaTeX templates, citation verification APIs, and conference checklists.
...
**Step 8: Limitations/Discussion Section (REQUIRED)**
...
## HCI Paper Structure: System + User Study

This section provides a specific structure for HCI papers that present a **new system/visualization technique** supported by **user studies**—the most common paper type for CHI and UIST.

### Standard Structure for System + User Study Papers
...
9. References
10. Appendices/Supplemental Materials (optional)
```

### Section-by-Section Guidance

#### Introduction
- Start with a concrete scenario or problem example
- Clearly state what makes this problem hard
- Briefly introduce your system and the insight behind it
- List 2-4 specific contributions
- Preview the key user study results

#### Related Work
- Organize by themes, not chronological
- Explicitly compare to the closest prior work
- Show how your approach is different and better
- Don't just list papers—synthesize them

#### System/Visualization Design
- Start with the **key insight** that enables your contribution
- Provide a high-level overview before details
- Explain design decisions and tradeoffs
- Include architecture diagrams or system screenshots
- Use Figure 1 as a teaser/overview figure

#### User Study
- Justify **why** this study design answers your research questions
- Report:
  - Participant demographics and recruitment
  - Study tasks (why these tasks?)
  - Measures (why these measures?)
  - Apparatus and procedure
- Present results clearly with:
  - Statistical support (p-values, confidence intervals)
  - Visualizations of results (charts, plots)
  - Qualitative findings if applicable
- Discuss what the results mean, not just what they are

#### Discussion
- Interpret your findings in context
- Discuss **threats to validity** (internal, external, construct)
- Be honest about limitations
- Provide specific, grounded future work (not just "more research is needed")

---

**Step 9: Paper Checklist**

CHI, UIST, IEEE VIS all require paper checklists. See [references/checklists.md](references/checklists.md).

---

## Writing Philosophy for Top HCI/Vis Conferences
...
|------------|------------|------------------------|-----------------|
| **CHI 2025/2026** | 10 pages | +0 | ACM format, double-blind, artifacts encouraged |
| **UIST 2025/2026** | 10 pages | +0 | ACM format, double-blind, demo option |
| **IEEE VIS 2025** | 10 pages (TVCG) | +2 | IEEE format, two-stage review |
| **EuroVis 2025** | 10 pages (CGF) | varies | Eurographics format |
| **PacificVis 2025** | 8-10 pages | varies | IEEE format |
| **CSCW 2025** | 10 pages | +0 | ACM format |
| **DIS 2025** | 10 pages | +0 | ACM format |

**Universal Requirements:**
- Double-blind review (anonymize submissions)
- References don't count toward page limit
- Appendices/Supplemental Materials unlimited
- LaTeX required for all venues
- Artifact evaluation encouraged for most venues
...
|------------|-----------|----------------|-------|
| CHI 2025/2026 | `acmart.tex` | `acmart.cls` | ACM Primary Article Template |
| UIST 2025/2026 | `acmart.tex` | `acmart.cls` | Same ACM format as CHI |
| IEEE VIS 2025 | `IEEEtran.tex` | `IEEEtran.cls` | IEEE Transactions format |
| EuroVis 2025 | `egconf.tex` | `egconf.cls` | Eurographics format |
| PacificVis 2025 | `IEEEtran.tex` | `IEEEtran.cls` | IEEE format |
| CSCW/DIS | `acmart.tex` | `acmart.cls` | ACM format |

---

## Conference Resubmission & Format Conversion

When a paper is rejected or withdrawn from one venue and resubmitted to another, format conversion is required. This is a common workflow in HCI/Vis research.
...
|-----------|-------------|-----------------|
| CHI → IEEE VIS | 10 → 10 pages | ACM → IEEE format, adjust for TVCG journal format |
| IEEE VIS → CHI | 10 → 10 pages | IEEE → ACM format |
| CHI → UIST | 10 → 10 pages | Same ACM format, emphasize technical depth |
| UIST → CHI | 10 → 10 pages | Same ACM format, emphasize user studies |
| Any → EuroVis | varies → 10 pages | IEEE/Eurographics format |
...
|--------------|-------------------|
| **CHI/UIST/CSCW/DIS** | ACM format, artifacts evaluation option |
| **IEEE VIS** | TVCG journal format, two-stage review |
| **EuroVis** | Eurographics format |
| **PacificVis** | IEEE format |
| **All venues** | Artifact submission encouraged |
...
Templates in `templates/` directory: **CHI/UIST/CSCW/DIS (ACM)**, **IEEE VIS/PacificVis (IEEE)**, **EuroVis (Eurographics)**.
...
**Venues:** [CHI](https://sigchi.org/) | [UIST](https://uist.acm.org/) | [IEEE VIS](https://ieeevis.org/) | [EuroVis](https://www.eurovis.org/) | [PacificVis](https://pacificvis.org/) | [CSCW](https://cscw.acm.org/) | [DIS](https://dis.acm.org/)
